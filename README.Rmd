...
- `data/` contains the datasets required for this project. These datasets may either be provided by the module leader and/or retrieved programmaticaly by the hackathon participants and saved into this directly;
...
- `reports/` contains Rmarkdown file/s for producing report/s produced by this scientific workflow;
    ...
    * `sudan_health_nutrition.Rmd` - Rmd file that produces the overall report
