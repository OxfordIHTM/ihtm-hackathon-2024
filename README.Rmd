...
- `data/` contains the datasets required for this project. These datasets may either be provided by the module leader and/or retrieved grammatically by the hackathon participants and saved into this directly;
...
The project workflow is currently divided into 6 discreate processes implemented in 6 different R scripts labelled:
