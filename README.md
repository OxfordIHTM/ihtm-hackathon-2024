...
**Hackathon 2024**. The **Hackathon 2024** event is part of the [MSc
...
To reproduce the HTML final report for this project, run the following
...
This will render the Rmarkdown found in the `reports` directory and
produce an HTML report called “sudan_health_nutrition.html” in the
`docs` directory.
